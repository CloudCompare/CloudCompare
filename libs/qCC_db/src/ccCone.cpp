...
bool ccCone::buildUp()
{
	...
	//invalid dimensions?
	if (m_height < CCLib::ZERO_TOLERANCE || m_bottomRadius + m_topRadius < CCLib::ZERO_TOLERANCE)
		return false;

	//topology
	bool singlePointBottom = (m_bottomRadius < CCLib::ZERO_TOLERANCE);
	bool singlePointTop = (m_topRadius < CCLib::ZERO_TOLERANCE);
