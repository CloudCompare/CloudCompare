...
#define ST_FOOTPRINTGROUP_BIT			0x00001000000000	//footprintgroup
#define ST_FOOTPRINT_BIT				0x00002000000000	//footprint
#define ST_BLOCKGROUP_BIT				0x00004000000000	//blockgroup
#define ST_BLOCK_BIT					0x00008000000000	//block
#define ST_MODEL_BIT					0x00010000000000	//model
...
namespace CC_TYPES
{
	enum : CC_CLASS_ENUM {
		...
		ST_PRIMITIVE = HIERARCHY_OBJECT | ST_STPRIMITIVE_BIT,
		ST_FOOTPRINTGROUP = HIERARCHY_OBJECT | ST_FOOTPRINTGROUP_BIT,
		ST_FOOTPRINT = HIERARCHY_OBJECT | ST_FOOTPRINT_BIT,
		ST_BLOCKGROUP = HIERARCHY_OBJECT | ST_BLOCKGROUP_BIT,
		ST_BLOCK = HIERARCHY_OBJECT | ST_BLOCK_BIT,
