...
#define CC_BUILDING_BIT					0x00000400000000	//building
#define CC_STPRIMITIVE_BIT				0x00000800000000	//stprimitive
#define CC_FOOTPRINTGROUP_BIT			0x00000400000000	//footprintgroup
#define CC_FOOTPRINT_BIT				0x00001000000000	//footprint
#define CC_BLOCKGROUP_BIT				0x00002000000000	//blockgroup
#define CC_BLOCK_BIT					0x00004000000000	//block
#define CC_MODEL_BIT					0x00008000000000	//model
#define CC_HYPOTHESIS_BIT				0x00004000000000	//hypothesis
//#define CC_FREE_BIT					...
...
namespace CC_TYPES
{
	enum : CC_CLASS_ENUM {
		...
		BUILDING = HIERARCHY_OBJECT | CC_BUILDING_BIT,		
		STPRIMITIVE = HIERARCHY_OBJECT | CC_STPRIMITIVE_BIT,
		FOOTPRINTGROUP = HIERARCHY_OBJECT | CC_FOOTPRINTGROUP_BIT,
		FOOTPRINT = HIERARCHY_OBJECT | CC_FOOTPRINT_BIT,
		BLOCKGROUP = HIERARCHY_OBJECT | CC_BLOCKGROUP_BIT,
		BLOCK = HIERARCHY_OBJECT | CC_BLOCK_BIT,
		MODEL = HIERARCHY_OBJECT | CC_MODEL_BIT,
