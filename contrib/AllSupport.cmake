...
function( target_link_contrib ) # 2 arguments: ARGV0 = project name / ARGV1 = shared lib export base folder (optional - '_debug' will be appended for debug configuration)
	...
	if ( ARGV1 ) # libraries with dynamic link can automatically 'install' there dynamic libraries

		# liblas support
		target_link_liblas( ${ARGV0} ${ARGV1} )
		# XIOT support
		target_link_XIOT( ${ARGV0} ${ARGV1} ${ARGV1}_debug )
		#GDAL support
		target_link_GDAL( ${ARGV0} ${ARGV1} ${ARGV1}_debug )
		
	else()
	
		# liblas support
		target_link_liblas( ${ARGV0} )
		# XIOT support
		target_link_XIOT( ${ARGV0} )
		#GDAL support
		target_link_GDAL( ${ARGV0} )
