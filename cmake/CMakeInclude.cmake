...
function( install_shared )	# 3 arguments:
	...
	if( NOT CMAKE_CONFIGURATION_TYPES )
		...
		install( TARGETS ${ARGV0} ${SHARED_LIB_TYPE} CONFIGURATIONS RelWithDebInfo DESTINATION ${ARGV1}_withDebInfo )
        if ( ${ARGC} GREATER 2 )
            if ( ${ARGV2} EQUAL 1 )
                install( TARGETS ${ARGV0} ${SHARED_LIB_TYPE} CONFIGURATIONS Debug DESTINATION ${ARGV1}_debug )
            endif()
        endif()
	endif()
endfunction()
