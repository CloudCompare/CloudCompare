    ...
    , public ccShiftedObject
{
  public:
	...
	**/
	...
	/** \param col RGB color
	 **/
	inline void setColor(const ccColor::Rgb& col)
	{
		m_rgbColor = col;
	}
	 ...
	 **/
	inline PointCoordinateType getWidth() const
	{
		return m_width;
	}
	 ...
	 **/
	inline const ccColor::Rgb& getColor() const
	{
		return m_rgbColor;
	}
