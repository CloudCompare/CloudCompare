...
public:
	...
	**/
	...
	//! Returns min corner
	const CCVector2d& getMinCorner() const { return m_minCorner; }
	//! Returns max corner
	const CCVector2d& getMaxCorner() const { return m_maxCorner; }

	//! Returns the equation coefficients
	inline const double* getEquationCoefs() const { return m_eq; }
