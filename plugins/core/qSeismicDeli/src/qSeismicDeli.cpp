...
// First:
//	Replace all occurrences of 'qSeismicDeli' by your own plugin class name in this file.
//	This includes the resource path to info.json in the constructor.

// Second:
//	Open qSeismicDeli.qrc, change the "prefix" and the icon filename for your plugin.
