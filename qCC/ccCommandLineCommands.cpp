...
bool CommandCPS::process(ccCommandLineInterface &cmd)
{
    ...
    ccPointCloud* compPointCloud = nullptr;
    ccPointCloud* refPointCloud = nullptr;
    CLCloudDesc compDesc;
    CLCloudDesc refDesc;
    ...
    compDesc = cmd.clouds().front();
    compPointCloud = compDesc.pc;
    refDesc = cmd.clouds()[1];
    refPointCloud = refDesc.pc;
    ...
    if (result >= 0)
    {
        ...
        newCloud = refPointCloud->partialClone(&closestPointSet);
