...
ccAnimationDlg::ccAnimationDlg( std::vector < VideoStepItem > & video_steps, ccGLWindow * main_window, QWidget* parent) :
	QDialog(parent),
	Ui::AnimationDialog(),
...
int ccAnimationDlg::GetCurrentListIndex()
{
...
void ccAnimationDlg::SetView ( cc2DViewportObject * current_params )
{
...
void ccAnimationDlg::RenderToFile ( const QString & filename )
{
	QApplication::processEvents();
	m_main_window->renderToFile(qPrintable( filename ), 1.0 , true, false );
}

void ccAnimationDlg::RunRender ()
{
...
void ccAnimationDlg::on_fpsSpinBox_valueChanged(double arg1)
{

	m_video_steps[ GetCurrentListIndex() ].fps = arg1 ;
}

void ccAnimationDlg::on_timeForStepBox_valueChanged(double arg1)
{
	m_video_steps[ GetCurrentListIndex() ].time_to_run = arg1 ;
}

void ccAnimationDlg::on_directoryButton_clicked()
{
...
void ccAnimationDlg::on_previewButton_clicked()
{
	Preview ();
}


void ccAnimationDlg::on_renderButton_clicked()
{
	RunRender ();
}

void ccAnimationDlg::on_stepSelectionList_itemSelectionChanged()
{
