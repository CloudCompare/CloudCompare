...
function( AddPlugin )
	...
	# Create our target
	qt_add_library( ${PLUGIN_TARGET} SHARED )
	...
	if( EXISTS "${QRC_FILE}" )
		qt_add_resources( generated_qrc_list ${QRC_FILE} )
		target_sources( ${PLUGIN_TARGET} PRIVATE ${generated_qrc_list} )
	else()
	...
	# It could be explicitly set to PRIVATE
	# But we have to make the change for ALL plugins
