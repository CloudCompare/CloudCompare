...
public:
     ...
     */
    virtual void addToDB(const QStringList& filenames, QString fileFilter = QString(),
     ...
     */
    void addToDB(ccHObject* obj, bool updateZoom = false, bool autoExpandDBTree = true, bool checkDimensions = false,
     ...
     */
    void spawnHistogramDialog(const std::vector<unsigned>& histoValues, double minVal, double maxVal, QString title,
...
private:
     ...
     */
    enum FastRegistrationMode { MoveBBCenterToOrigin, MoveBBMinCornerToOrigin, MoveBBMaxCornerToOrigin };
     ...
     */
    void createComponentsClouds(ccGenericPointCloud* cloud, CCCoreLib::ReferenceCloudContainer& components,
                                unsigned minPointPerComponent, bool randomColors, bool selectComponents,
...
private: // members
    ...
    struct ccMDIDialogs {
         ...
         */
        ccMDIDialogs(ccOverlayDialog* dlg, Qt::Corner pos) : dialog(dlg), position(pos) {}
    };
