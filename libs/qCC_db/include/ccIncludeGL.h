...
class ccGL
{
  public:
	...
	static inline void Vertex3v(QOpenGLFunctions_2_1* glFunc, const float* v)
	{
		glFunc->glVertex3fv(v);
	}
	...
	static inline void Vertex3(QOpenGLFunctions_2_1* glFunc, float x, float y, float z)
	{
		glFunc->glVertex3f(x, y, z);
	}
	static inline void Vertex3(QOpenGLFunctions_2_1* glFunc, double x, double y, double z)
	{
		glFunc->glVertex3d(x, y, z);
	}

	// type-less glScaleX call (X=f,d)
	static inline void Scale(QOpenGLFunctions_2_1* glFunc, float x, float y, float z)
	{
		glFunc->glScalef(x, y, z);
	}
	static inline void Scale(QOpenGLFunctions_2_1* glFunc, double x, double y, double z)
	{
		glFunc->glScaled(x, y, z);
	}

	// type-less glNormal3Xv call (X=f,d)
	static inline void Normal3v(QOpenGLFunctions_2_1* glFunc, const float* v)
	{
		glFunc->glNormal3fv(v);
	}
	static inline void Normal3v(QOpenGLFunctions_2_1* glFunc, const double* v)
	{
	...
	{
		glFunc->glRotatef(a, x, y, z);
	}
	static inline void Rotate(QOpenGLFunctions_2_1* glFunc, double a, double x, double y, double z)
	{
		glFunc->glRotated(a, x, y, z);
	}

	// type-less glTranslateX call (X=f,d)
	static inline void Translate(QOpenGLFunctions_2_1* glFunc, float x, float y, float z)
	{
	...
	static inline void Color3v(QOpenGLFunctions_2_1* glFunc, const unsigned char* v)
	{
		glFunc->glColor3ubv(v);
	}
	static inline void Color3v(QOpenGLFunctions_2_1* glFunc, const float* v)
	{
		glFunc->glColor3fv(v);
	}

	// type-less glColor4Xv call (X=f,ub)
	static inline void Color4v(QOpenGLFunctions_2_1* glFunc, const unsigned char* v)
	{
		glFunc->glColor4ubv(v);
	}
	static inline void Color4v(QOpenGLFunctions_2_1* glFunc, const float* v)
	{
		glFunc->glColor4fv(v);
	}

	// ccColor dedicated calls
	static inline void Color(QOpenGLFunctions_2_1* glFunc, const ccColor::RgbaTpl<unsigned char>& col)
	{
		glFunc->glColor4ubv(col.rgba);
	}
	static inline void Color(QOpenGLFunctions_2_1* glFunc, const ccColor::RgbaTpl<float>& col)
	{
		glFunc->glColor4fv(col.rgba);
	}
	static inline void Color(QOpenGLFunctions_2_1* glFunc, const ccColor::RgbTpl<unsigned char>& col)
	{
		glFunc->glColor3ubv(col.rgb);
	}
	static inline void Color(QOpenGLFunctions_2_1* glFunc, const ccColor::RgbTpl<float>& col)
	{
		glFunc->glColor3fv(col.rgb);
	}
  ...
  public: // GLU equivalent methods
	...
	inline static double& MAT(double* m, int r, int c)
	{
		return m[c * 4 + r];
	}
	inline static float& MAT(float* m, int r, int c)
	{
		return m[c * 4 + r];
	}
