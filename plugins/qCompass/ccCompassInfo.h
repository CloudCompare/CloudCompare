...
public:
		...
		QDialog(parent)
	{
		...
		l->setText("<!DOCTYPE html>"
			...
			"<li>Darkness [default] - traces follow dark points in the cloud. This is good for fracture traces defined by shadow."
			"<li>Lightness - traces follow light points in the cloud. This is good for light-coloured structures such as veins."
			"<li>RGB - traces avoid colour contrasts, following points with a similar colour to the start and end points."
			...
			"</ul></p><p>When using this tool it is important to note that its <b>performance (i.e. speed) scales with trace length</b>. "
